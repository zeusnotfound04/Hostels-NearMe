...
const SideBorder = () => (
  <div className="absolute top-4 bottom-4 w-2 md:w-4">
...
const JaggedBorder = () => (
  <div className="absolute top-0 bottom-0 w-6 md:w-12">
    <svg className="h-full w-6 md:w-12" viewBox="0 0 48 400" preserveAspectRatio="none">
...
export default function MissionVisionCards() {
  return (
    <div className="relative flex flex-col md:flex-row w-full max-w-7xl gap-8 md:gap-16 p-4 md:p-8">
      {/* Left Jagged Border - Hidden on mobile */}
      <div className="absolute -left-3 md:-left-6 top-0 bottom-0 hidden md:block">
        <JaggedBorder />
      </div>
      
      {/* Right Jagged Border - Hidden on mobile */}
      <div className="absolute -right-3 md:-right-6 top-0 bottom-0 hidden md:block">
        <JaggedBorder />
      </div>
      ...
      <div className="relative flex-1 p-6 md:p-12">
        ...
        <h2 className="mb-3 md:mb-6 text-2xl md:text-4xl font-black">Who We Are?</h2>
      ...
      <div className="relative w-full h-4 md:w-4 md:h-auto my-8 md:my-0">
      ...
      <div className="relative flex-1 p-6 md:p-12">
        ...
        <div className="mb-6 md:mb-12">
          <h2 className="mb-3 md:mb-6 text-2xl md:text-4xl font-black">Our Mission</h2>
          <p className="text-sm md:text-base leading-relaxed">
        ...
        <div>
          <h2 className="mb-3 md:mb-6 text-2xl md:text-4xl font-black">Our Vision</h2>
          <p className="text-sm md:text-base leading-relaxed">
