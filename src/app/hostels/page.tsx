...
export default function Page() {
  ...
  const [filters, setFilters] = useState({
    ...
    sharingType: "",
    sort: "",
    priceRange: [0, 50000] as [number, number], // Default price range
  });
  ...
  const { data, isLoading, error } = useFetchHostels({
    ...
    hostelType: queryParams.hostelType,
});
  ...
  const handleApplyFilters = () => {
    ...
    // For now, we're just updating the URL structure
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="py-4">
            <RadioGroup 
              ...
              onValueChange={(value : any) => setFilters({...filters, hostelType: value})}
              className="flex flex-col gap-2"
            >
              <div className="flex items-center space-x-2">
          ...
          <div className="py-4">
            ...
            <div className="px-2">
              <Slider
                ...
                onValueChange={(value :any ) => setFilters({...filters, priceRange: value as [number, number]})}
              />
